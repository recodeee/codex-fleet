...
You are the `writer` role for OpenSpec plan `agent-codex-masterplan-design-i-match-fleet-waves-spawn-timelin-2026-05-18-14-22`.
...
- `openspec/plan/agent-codex-masterplan-design-i-match-fleet-waves-spawn-timelin-2026-05-18-14-22/writer/tasks.md`
- `openspec/plan/agent-codex-masterplan-design-i-match-fleet-waves-spawn-timelin-2026-05-18-14-22/writer/proposal.md`
