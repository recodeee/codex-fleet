...
You are the `planner` role for OpenSpec plan `agent-codex-masterplan-design-i-match-fleet-waves-spawn-timelin-2026-05-18-14-22`.
...
- `openspec/plan/agent-codex-masterplan-design-i-match-fleet-waves-spawn-timelin-2026-05-18-14-22/planner/tasks.md`
- `openspec/plan/agent-codex-masterplan-design-i-match-fleet-waves-spawn-timelin-2026-05-18-14-22/planner/proposal.md`
